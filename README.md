...
Vehicle-specific make, model, minimum year, refresh interval, call ceiling, labels, official-dealer matching, and approved listing domains are defined in `data/site-config.json`. That public configuration contains no API credentials or provider endpoint.
